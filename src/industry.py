...
class IndustryPrimaryOrganicNitrates(IndustryPrimary):
    """
    Industry that is organic AND has production boosted by delivery of NITR (farms and similar)
    Sparse subclass of IndustryPrimary, do not add much to this, it's subclassed once already
    """

    def __init__(self, **kwargs):
        kwargs["accept_cargo_types"] = ["NITR"]
        kwargs["life_type"] = "IND_LIFE_TYPE_ORGANIC"
        super().__init__(**kwargs)
        self.supply_requirements = [
            0,
...
class IndustrySecondary(Industry):
    ...
    def __init__(self, **kwargs):
        ...
        self.closes_when_starved = kwargs.get("closes_when_starved", True)
        register_perm_storage_mapping(
            self.__class__.__name__,
            [
