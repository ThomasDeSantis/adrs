...
industry.add_spritelayout(
    id="naval_yard_spritelayout_truck",
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_checkpoint",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_containers_jetty_1",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_containers_jetty_2",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_small_hut",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
#New crane SW
industry.add_spritelayout(
    id="naval_yard_spritelayout_crane_sw_1",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_crane_sw_2",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
#New crane SW
industry.add_spritelayout(
    id="naval_yard_spritelayout_crane_se_1",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_crane_se_2",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
#New crane NW
industry.add_spritelayout(
    id="naval_yard_spritelayout_crane_nw_1",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_crane_nw_2",
    tile="naval_yard_tile_1",
    ground_sprite=sprite_ground,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_small_stack",
    tile="naval_yard_tile_1",
    ground_sprite=spriteset_ground_empty,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[
...
industry.add_magic_spritelayout(
    ...
    base_id="naval_yard_spritelayout_coast_checkpoint",
    tile="naval_yard_tile_2",
    config={
...
industry.add_magic_spritelayout(
    type="harbour_coast_foundations",
    base_id="naval_yard_spritelayout_coast_office",
    tile="naval_yard_tile_2",
    config={
        "ground_sprite": spriteset_ground_empty,  # should alqways be empty for this magic spritelayout
...
industry.add_magic_spritelayout(
    type="harbour_coast_foundations",
    base_id="naval_yard_spritelayout_coast_containers_1",
    tile="naval_yard_tile_2",
    config={
        "ground_sprite": spriteset_ground_empty,  # should alqways be empty for this magic spritelayout
...
industry.add_magic_spritelayout(
    type="harbour_coast_foundations",
    base_id="naval_yard_spritelayout_coast_containers_2",
    tile="naval_yard_tile_2",
    config={
        "ground_sprite": spriteset_ground_empty,  # should alqways be empty for this magic spritelayout
...
industry.add_magic_spritelayout(
    type="harbour_coast_foundations",
    base_id="naval_yard_spritelayout_coast_containers_3",
    tile="naval_yard_tile_2",
    config={
        "ground_sprite": spriteset_ground_empty,  # should alqways be empty for this magic spritelayout
...
industry.add_magic_spritelayout(
    type="harbour_coast_foundations",
    base_id="naval_yard_spritelayout_coast_truck",
    tile="naval_yard_tile_2",
    config={
        "ground_sprite": spriteset_ground_empty,  # should alqways be empty for this magic spritelayout
...
industry.add_spritelayout(
    id="naval_yard_spritelayout_reserved_water",
    tile="naval_yard_tile_1",
    ground_sprite=sprite_ground,
    ground_overlay=spriteset_ground_empty,
    building_sprites=[],
...
industry.add_industry_layout(
    id="naval_yard_industry_layout_1",
    layout=[
        (0, 0, "naval_yard_spritelayout_reserved_water"),
        (0, 2, "naval_yard_spritelayout_containers_jetty_1"),
        (0, 3, "naval_yard_spritelayout_small_hut"),
        (0, 4, "naval_yard_spritelayout_coast_containers_1"),
        (0, 5, "naval_yard_spritelayout_coast_containers_3"),
        (1, 0, "naval_yard_spritelayout_reserved_water"),
        (1, 1, "spritelayout_null_water"),
        (1, 2, "naval_yard_spritelayout_crane_sw_2"),
        (1, 3, "naval_yard_spritelayout_crane_sw_1"),
        (1, 4, "naval_yard_spritelayout_truck"),
        (1, 5, "naval_yard_spritelayout_coast_containers_2"),
    ],
)
industry.add_industry_layout(
    id="naval_yard_industry_layout_2",
    layout=[
        (0, 0, "naval_yard_spritelayout_coast_containers_2"),
        (0, 1, "naval_yard_spritelayout_coast_office"),
        (0, 2, "naval_yard_spritelayout_coast_checkpoint"),
        (0, 3, "naval_yard_spritelayout_coast_containers_3"),
        (1, 0, "naval_yard_spritelayout_24"),
        (1, 1, "spritelayout_null_water"),
        (1, 2, "naval_yard_spritelayout_truck"),
        (2, 1, "naval_yard_spritelayout_crane_nw_2"),
        (2, 2, "naval_yard_spritelayout_crane_nw_1"),
        (2, 3, "naval_yard_spritelayout_22"),
        (2, 4, "spritelayout_null_water"),
        (3, 1, "naval_yard_spritelayout_26"),
        (3, 2, "naval_yard_spritelayout_small_hut"),
        (3, 3, "spritelayout_null_water"),
        (4, 0, "naval_yard_spritelayout_reserved_water"),
        (4, 1, "naval_yard_spritelayout_reserved_water"),
        (4, 2, "naval_yard_spritelayout_reserved_water"),
        (4, 3, "naval_yard_spritelayout_reserved_water"),
        (4, 4, "naval_yard_spritelayout_reserved_water"),
    ],
)
industry.add_industry_layout(
    id="naval_yard_industry_layout_3",
    layout=[
        (0, 0, "naval_yard_spritelayout_coast_office"),
        (0, 1, "naval_yard_spritelayout_truck"),
        (0, 2, "naval_yard_spritelayout_crane_sw_2"),
        (0, 3, "naval_yard_spritelayout_crane_sw_1"),
        (0, 4, "naval_yard_spritelayout_small_stack"),
        (0, 5, "spritelayout_null_water"),
        (0, 6, "naval_yard_spritelayout_reserved_water"),
        (1, 0, "naval_yard_spritelayout_coast_containers_1"),
        (1, 1, "naval_yard_spritelayout_small_hut"),
        (1, 2, "naval_yard_spritelayout_25"),
        (1, 4, "naval_yard_spritelayout_25"),
        (1, 5, "spritelayout_null_water"),
        (1, 6, "naval_yard_spritelayout_reserved_water"),
        (2, 0, "naval_yard_spritelayout_coast_containers_2"),
        (2, 1, "naval_yard_spritelayout_small_stack"),
        (2, 2, "spritelayout_null_water"),
        (2, 6, "naval_yard_spritelayout_reserved_water"),
        (3, 1, "spritelayout_null_water"),
        (3, 2, "spritelayout_null_water"),
        (3, 6, "naval_yard_spritelayout_reserved_water"),
    ],
)
