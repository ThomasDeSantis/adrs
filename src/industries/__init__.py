...
from industries import airbase

airbase.industry.register()

from industries import aircraft_works

aircraft_works.industry.register()
...
from industries import arms_works

arms_works.industry.register()

from industries import assembly_plant

assembly_plant.industry.register()

from industries import barracks

barracks.industry.register()
...
from industries import blood_wizard_tower

blood_wizard_tower.industry.register()
...
from industries import electronics_works

electronics_works.industry.register()
...
from industries import gold_mine

gold_mine.industry.register()
...
from industries import grain_farm

grain_farm.industry.register()
...
from industries import jewelry_shop

jewelry_shop.industry.register()
...
from industries import mint

mint.industry.register()

from industries import naval_yard

naval_yard.industry.register()
...
from industries import powder_mill

powder_mill.industry.register()
...
from industries import tank_works

tank_works.industry.register()
